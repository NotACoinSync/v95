...
public class NPCScriptManager extends AbstractScriptManager {
        ...
        try {
            ...
            if (c.canClickNPC()) {
                ...
                if (fileName != null) {
                    ...
                    if (se == null) {
                        se = getInvocable("npc/" + fileName + ".js", c);
                    }
                    if (se != null) {
                        info += fileName;
                    }
                ...
                if (c.getPlayer().getScriptDebug()) {
                    c.getPlayer().dropMessage(MessageType.MAPLETIP, "NPC Script: " + info);
                }
                ...
                try {
                    if (args != null && args.length > 0) {
                        ...
                        iv.invokeFunction(startFunction);
                    }
    ...
    public boolean scriptExist(int npc, MapleClient c) {
        if (c.getPlayer().getScriptDebug()) {
            c.getPlayer().dropMessage(MessageType.MAPLETIP, "NPC: " + npc);
        }
