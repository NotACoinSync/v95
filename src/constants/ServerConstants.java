...
public class ServerConstants {
    ...
    // Login Configuration
    public static final int CHANNEL_LOAD = 200;
    ...
    public static final boolean ENABLE_WORLD_RANK = true;
    // Rates
    public static int PARTY_EXPERIENCE_MOD = 1; // change for event stuff
    public static final double PQ_BONUS_EXP_MOD = 1;
    public static final int EXP_RATE = 9999;
    public static final int MESO_RATE = 99;
    public static final int DROP_RATE = 9;
    // shutdown
    ...
    // Events
    public static double expEvent = 50;
    public static long expEventEnd = 0;
    public static int PotionDiscountRate = 50;
    public static boolean CakePie = false;
    // Other Configuration
    public static boolean JAVA_8;
    public static boolean SHUTDOWNHOOK;
    public static boolean WZ_LOADING;
    public static boolean BIN_DUMPING;
