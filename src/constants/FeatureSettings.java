...
public class FeatureSettings {
    ...
    //
    public static boolean MTS = true;
    ...
    //
    public static boolean PACKAGE_DELIVERER = false;
    public static String PACKAGE_DELIVERER_DISABLED = "Package Deliverer has been temporarily disabled.";
    //
