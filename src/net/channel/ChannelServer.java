...
public class ChannelServer {
    ...
    private int expRate = ServerConstants.EXP_RATE, questExpRate = 1, dropRate = ServerConstants.DROP_RATE, mesoRate = ServerConstants.MESO_RATE;
    ...
    private ChannelServer() {
        ...
        System.out.println("Loaded MobSkills in " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " seconds");
        ...
        System.out.println("Loaded " + getChannels().size() + " Channels in " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " seconds");
        timeToTake = System.currentTimeMillis();

        SkillFactory.loadAllSkills();
        System.out.println("Loaded " + SkillFactory.getSkills().size() + " Skills in " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " seconds");
        timeToTake = System.currentTimeMillis();
        ...
        System.out.println("Loaded " + CashItemFactory.getCashItems().size() + " Cash Items in " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " seconds");
        timeToTake = System.currentTimeMillis();

        MapleQuest.loadAllQuest();
        System.out.println("Loaded " + MapleQuest.getQuests() + " Quests in " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " seconds");
        timeToTake = System.currentTimeMillis();

        MobConstants.loadSlayerMonsters(this);
        System.out.println("Loaded " + MobConstants.getSlayerMobs() + " Slayer Monsters in " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " seconds");
        timeToTake = System.currentTimeMillis();

        MapleCharacterInfo.getInstance();
        System.out.println("Loaded " + MapleCharacterInfo.getFaces().size() + MapleCharacterInfo.getHairs().size() + " Faces & Hairs in " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " seconds");
    ...
    public MapleClient getClientGlobal(int id) {
        for (Channel ch : getChannels()) {
            for (MapleCharacter player : ch.getPlayerStorage().getAllCharacters()) {
                if (player.getAccountID() == id || player.getClient().getAccountName().equals(String.valueOf(id))) {
