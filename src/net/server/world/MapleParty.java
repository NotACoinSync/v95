...
public class MapleParty implements Externalizable {
    ...
    /**
     * LoadParty(0), CreateNewParty(1), WithdrawParty(2), JoinParty(3),
     * InviteParty(4), KickParty(5), LoadParty_Done(6), CreateNewParty_Done(7),
     * CreateNewParty_AlreayJoined(8), CreateNewParty_Beginner(9),
     * CreateNewParty_Unknown(10), WithdrawParty_Done(11),
     * WithdrawParty_NotJoined(12), WithdrawParty_Unknown(13),
     * JoinParty_Done(14), JoinParty_AlreadyJoined(15),
     * JoinParty_AlreadyFull(16), JoinParty_UnknownUser(17),
     * JoinParty_Unknown(18), InviteParty_BlockedUser(19),
     * InviteParty_AlreadyInvited(20), InviteParty_Rejected(21),
     * AdminCannotCreate(24), AdminCannotInvite(23), UnableToFindPlayer(25),
     * UserMigration(26), ChangeLevelOrJob(27), TownPortalChanged(28);
     */
    public MapleParty() {
        super();
    }
    ...
    public int getIndex(MaplePartyCharacter target) {
        for (int i = 0; i < members.size(); i++) {
            if (members.get(i).getId() == target.getId()) {
                return i;
            }
        }
        return -1;
