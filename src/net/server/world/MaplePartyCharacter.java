...
public class MaplePartyCharacter implements Externalizable {
    ...
    private int PQReward, PQRewardType, PQRewardMobTemplateID, bPQReward;
    ...
    public int getPQRewardType() {
        return PQRewardType;
    }

    public int getPQRewardMobTemplateID() {
        return PQRewardMobTemplateID;
    }

    public int getbPQReward() {
        return bPQReward;
    }
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        out.writeInt(PQReward);
        out.writeInt(PQRewardType);
        out.writeInt(PQRewardMobTemplateID);
        out.writeInt(bPQReward);
    }
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        PQReward = in.readInt();
        PQRewardType = in.readInt();
        PQRewardMobTemplateID = in.readInt();
        bPQReward = in.readInt();
    }
}
