package net.server.handlers.Parcel;
...
public final class DueyHandler extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor iPacket, MapleClient c) {
        if (!FeatureSettings.PACKAGE_DELIVERER) {
            c.getPlayer().dropMessage(MessageType.POPUP, FeatureSettings.PACKAGE_DELIVERER_DISABLED);
