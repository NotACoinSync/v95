...
public final class ReactorHitHandler extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        /*int bSkill = */
        slea.readInt(); // FindHitReactor: 0, FindSkillReactor: 1
        ...
        if (reactor != null && reactor.isAlive()) {
            ...
            Logger.log(LogType.ERROR, LogFile.GENERAL_ERROR, c.getPlayer().getName() + " is trying to hit a null, or dead reactor");
        }
    }
}
