...
/**
 * @author iPoopMagic (David) b/c screw you SQL! & I love Singleton
 */
        ...
        if (ServerConstants.WZ_LOADING) {
            ...
            if (ServerConstants.BIN_DUMPING && !binFile.exists()) {
                try {
                    ...
                    oPacket.writeInt(makerItemCreateCache.size());
                    for (int i : makerItemCreateCache.keySet()) {
                        oPacket.writeInt(i);
                        makerItemCreateCache.get(i).save(oPacket);
                    }
                    oPacket.writeInt(gemCreateCache.size());
                    for (int i : gemCreateCache.keySet()) {
                        oPacket.writeInt(i);
                        gemCreateCache.get(i).save(oPacket);
                    }
