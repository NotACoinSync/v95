    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill, boolean costMana) {
        ...
        switch (skillId) {
            ...
            case 114:
                ...
                break;
            case 120:
                disease = SecondaryStat.Seal;
                break;
            case 121:
                disease = SecondaryStat.Darkness;
                break;
            case 122:
                disease = SecondaryStat.Weakness;
                break;
            case 123:
                disease = SecondaryStat.Stun;
                break;
            case 124:
                disease = SecondaryStat.Curse;
                break;
            case 125:
                disease = SecondaryStat.Poison;
                break;
            case 126: // Slow
                disease = SecondaryStat.Slow;
                break;
            case 127:
                if (lt != null && rb != null && skill) {
            ...
            case 129: // Banish
                ...
                break;
            case 131: // Affected Area
                monster.getMap().spawnAffectedArea(new MapleAffectedArea(calculateBoundingBox(monster.getPosition(), true), monster, this, x * 10), false);
                break;
            case 132:
                disease = SecondaryStat.ReverseInput;
                break;
            case 133: // zombify
                disease = SecondaryStat.Undead;
                break;
            case 140:
        ...
        if (disease != null) {
            if (lt != null && rb != null && skill) {
                int i = 0;
                for (MapleCharacter character : getPlayersInRange(monster, player)) {
                    if (character.isActiveBuffedValue(Bishop.HOLY_SHIELD)) {
                        continue;
                    }
                    if (disease.equals(SecondaryStat.Attract)) {
                        if (i < 10) {
