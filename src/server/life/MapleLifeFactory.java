...
public class MapleLifeFactory {
        ...
        if (ServerConstants.WZ_LOADING && data == null) {
            ...
            if (ServerConstants.BIN_DUMPING) {
                ...
                for (Entry<Integer, List<Integer>> e : MapleLifeFactory.questCountGroup.entrySet()) {
                    oPacket.writeInt(e.getKey());
                    oPacket.writeInt(e.getValue().size());
    ...
    public static void loadAllMobs() {
        ...
        for (MapleDataFileEntry mdfe : data.getRoot().getFiles()) {
            if (mdfe.getName().equals("QuestCountGroup")) {
                continue;
            }
    ...
    private static void loadMonsterStats(int mid, MapleData monsterData, MapleData monsterInfoData, MapleMonsterStats stats) {
        ...
        if (monsterInfoData.getChildByPath("damagedByMob") != null) {
            stats.setFriendly(MapleDataTool.getIntConvert("damagedByMob", monsterInfoData, 0) == 1);
        }
        if (monsterInfoData.getChildByPath("PADamage") != null) {
            stats.setPADamage(MapleDataTool.getInt("PADamage", monsterInfoData));
        }
        if (monsterInfoData.getChildByPath("PDDamage") != null) {
            stats.setPDDamage(MapleDataTool.getInt("PDDamage", monsterInfoData));
        }
        if (monsterInfoData.getChildByPath("MADamage") != null) {
            stats.setMADamage(MapleDataTool.getInt("MADamage", monsterInfoData));
        }
        if (monsterInfoData.getChildByPath("MDDamage") != null) {
            stats.setMDDamage(MapleDataTool.getInt("MDDamage", monsterInfoData));
        }
        ...
        if (monsterStandData != null) {
            ...
            if (monsterStandData0 != null) {
                stats.setOrigin(MapleDataTool.getPoint("origin", monsterStandData0));
            }
        }
