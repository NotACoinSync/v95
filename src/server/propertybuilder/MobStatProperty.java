...
public class MobStatProperty {
    ...
    public boolean equals(Object obj) {
        ...
        if (Double.doubleToLongBits(expMultiplier) != Double.doubleToLongBits(other.expMultiplier)) {
            return false;
        }
        if (Double.doubleToLongBits(hpMultiplier) != Double.doubleToLongBits(other.hpMultiplier)) {
            return false;
        }
        if (Double.doubleToLongBits(levelMultiplier) != Double.doubleToLongBits(other.levelMultiplier)) {
            return false;
        }
        if (Double.doubleToLongBits(mpMultiplier) != Double.doubleToLongBits(other.mpMultiplier)) {
            return false;
        }
        return true;
    }
