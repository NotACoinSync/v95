...
public class HPQ extends PartyQuest {
    ...
    @Override
    public boolean calcAndUpdateRank(MapleCharacter chr, final PartyQuestRankRecord pqRankRecord) {
    ...
    public static void giveRandomizedRiceCakeHat(MapleCharacter chr) {
        ...
        chr.getClient().announce(EffectPacket.Local.Quest(hatId, (short) 1));
    }
