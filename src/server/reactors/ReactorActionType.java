...
public enum ReactorActionType {
    ...
    /**
     * public class ReactorEventType { public static final int Hit = 0, HitLeft
     * = 1, HitRight = 2, HitJump_Left = 3, HitJump_Right = 4, HitSkill_Check =
     * 5, 6 and 7 might be a kms or something specific thing? Gather = 8,
     * Click_Check = 9, Mob_Check = 10, CharacterAct = 11, RemoveReactor = 12,
     * HitJump = 13, FindItem_Update = 100, Timeout_Reset = 101, Key_Check1 =
     * 200, Key_Check2 = 201; }
     */
    final int type;
