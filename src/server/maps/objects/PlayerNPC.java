...
public class PlayerNPC extends AbstractMapleMapObject {
    ...
    /**
     * Script IDS: Total: 9901000 - 9901319 RSSkills: 9901000 - 9901030
     */
    ...
    public void addToMaps() {
        for (Channel channel : ChannelServer.getInstance().getChannels()) {
            ...
            m.announce(NpcPool.spawnPlayerNPC(this));
            m.announce(NpcPool.NpcImitateData(this));
            m.addMapObject(this);
        }
    }
    ...
    public void sendSpawnData(MapleClient client) {
        client.announce(NpcPool.spawnPlayerNPC(this));
        client.announce(NpcPool.NpcImitateData(this));
    }
