...
public class Kite extends AbstractMapleMapObject {
    ...
    public void destroyKite() {
        ...
        if (map != null) {
            map.announce(MessageBoxPool.MessageBoxLeaveField(getObjectId(), (byte) 0));
    ...
    public void sendSpawnData(MapleClient client) {
        client.announce(MessageBoxPool.MessageBoxEnterField(this));
    }

    @Override
    public void sendDestroyData(MapleClient client) {
        client.announce(MessageBoxPool.MessageBoxLeaveField(getObjectId(), (byte) 0));
    }
