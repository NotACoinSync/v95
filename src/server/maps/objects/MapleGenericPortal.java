...
public class MapleGenericPortal implements MaplePortal {
    ...
    public void save(MaplePacketLittleEndianWriter oPacket) {
        ...
        oPacket.writeInt(targetmap);
        oPacket.writeInt(type);
        oPacket.writeBoolean(status);
        oPacket.write(id);
        oPacket.writeBoolean(scriptName != null);
        if (scriptName != null) {
            oPacket.writeMapleAsciiString(scriptName);
        }
        oPacket.writeBoolean(portalState);
    }
    ...
    public void load(LittleEndianAccessor slea) {
        ...
        id = slea.readByte();
        if (slea.readBoolean()) {
            scriptName = slea.readMapleAsciiString();
        }
