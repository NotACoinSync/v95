...
public class MonsterCarnivalSettings {
    ...
    /**
     * Max amount of guardians in the map Can sometimes be null
     */
    private int guardianGenMax;
    /**
     * 0-10, key foothold x,y
     */
    private Map<Integer, Pair<Integer, Point>> guardianGenPos = new HashMap<Integer, Pair<Integer, Point>>();
    /**
     * If the map is divided. TODO: Why does nexon care?
     */
    private int mapDivided;
    /**
     * 0-9, key mob id mobTime spendCP - Amount of CP to spawn
     */
    ...
    /**
     * Key Position info for mobs. cy, fh, point(x, y)
     */
    ...
    /**
     * Amount of time added in seconds you get when expanded. TODO: no clue how
     * to expand..
     */
