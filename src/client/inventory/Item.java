...
public class Item implements Comparable<Item> {
    ...
    public boolean equalss(Object item) {
        ...
        if (lockExpiration != other.lockExpiration) {
            return false;
        }
        if (!giftFrom.equals(other.giftFrom)) {
            return false;
        }
        return true;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (giftFrom == null) {
            if (other.giftFrom != null) {
                return false;
            }
        } else if (!giftFrom.equals(other.giftFrom)) {
            return false;
        }
        if (id != other.id) {
            return false;
