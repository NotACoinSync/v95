                    ...
                    if (!c.getPlayer().battleAnaylsis.running) {
                        ...
                        if (args.length > 1) {
                            ...
                            if (minutes != null) {
                                ...
                                c.getPlayer().dropMessage(MessageType.ERROR, "Enter a valid integer for how many minutes you want.");
                            }
                        } else {
                            c.getPlayer().dropMessage(MessageType.MAPLETIP, "BattleAnalysis is now running.");
                        }
                    } else {
                        c.getPlayer().dropMessage(MessageType.ERROR, "You already have a Battle Analysis running.");
                    }
                    break;
                }
                case "stop": {
