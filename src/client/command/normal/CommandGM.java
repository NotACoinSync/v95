...
public class CommandGM extends Command {
    ...
    public boolean execute(MapleClient c, String commandLabel, String[] args) {
        ...
        try {
            ChannelServer.getInstance().getWorldInterface().broadcastGMPacket(WvsContext.SetWeekEventMessage("[GM MESSAGE]:" + MapleCharacter.makeMapleReadable(c.getPlayer().getName()) + ": " + message));
        } catch (Exception ex) {
