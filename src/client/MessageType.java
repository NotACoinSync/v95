...
public enum MessageType {
    ...
    /**
     * public static final int Notice = 0, Alert = 1, SpeakerChannel = 2,
     * SpeakerWorld = 3, Slide = 4, Event = 5, NoticeWithoutPrefix = 6,
     * UtilDlgEX = 7, ItemSpeaker = 8, SpeakerBridge = 9, ArtSpeakerWorld = 10,
     * BlowWeather = 11, GachaponAnnounce = 12, GachaponAnnounce_Open = 13,
     * GachaponAnnounce_Copy = 14, UListClip = 15, FreeMarketClip = 16,
     * DestroyShop = 17, CashShopAD = 18, HeartSpeaker = 19, SkullSpeaker = 20,
     * // KMS Exclusives GachaponMsg = 12, AnnouncedQuest_Open = 13,
     * AnnouncedQuest_Closed = 14, MiracleTime = 15, EventMsg_With_Channel = 16,
     * LotteryItemSpeaker = 17, LotteryItemSpeaker_World = 18,
     * MonsterLife_WorldMsg = 19, NoticeWindow = 20, PickupItem_World = 21,
     * MakingSkillMeisterItem = 22, SpeakerWorld_GuildSkill = 23, WeatherMsg =
     * 24, NO = 20 ;
     */
