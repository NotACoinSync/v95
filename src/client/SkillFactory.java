    ...
    private static Skill loadFromData(int id, MapleData data, MapleData delayData) {
        ...
        if (common != null) {
            ...
            for (int i = 0; i < maxLevel; i++) {
                ret.effects.add(MapleStatEffect.loadSkillEffectFromData(data.getChildByPath("common"), id, isBuff, i + 1));
            }
        } else {
        ...
        ret.combatOrders = MapleDataTool.getInt("combatOrders", data, 0);
        ret.animationTime = 0;
        if (effect != null) {
