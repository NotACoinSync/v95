...
public enum MapleJob {
    ...
    public boolean isMagician() {
        ...
        if (jobid >= 1200 && jobid <= 1212) {
            return true;
        }
        if (JobConstants.is_evan_job(jobid)) {
            return true;
        }
        return false;
    }
    ...
    public boolean isThief() {
        ...
        if (jobid >= 1400 && jobid <= 1412) {
            return true;
        }
        if (JobConstants.is_dualblade_job(jobid)) {
            return true;
        }
        return false;
    }
