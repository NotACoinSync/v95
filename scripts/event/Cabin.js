...
function scheduleNew() {
    ...
    Leafre_docked.announce(Packages.tools.packets.CField.ContiMove.State(1, false));
...
function takeoff() {
    ...
    Leafre_docked.announce(Packages.tools.packets.CField.ContiMove.State(2, false));
