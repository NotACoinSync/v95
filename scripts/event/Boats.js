...
function init() {
    ...
    Ellinia_btf = em.getChannelServer().getMap(104020111);
    ...
    Ellinia_docked = em.getChannelServer().getMap(104020110);
...
function scheduleNew() {
    Ellinia_docked.setDocked(true);
    Orbis_docked.setDocked(true);
    Ellinia_docked.announce(Packages.tools.packets.CField.ContiMove.State(1, false));
...
function takeoff() {
    ...
    Ellinia_docked.announce(Packages.tools.packets.CField.ContiMove.State(2, false));
...
function invasion() {
    ...
    var numspawn = chance > 5 ? 2 : 0;
     if(numspawn > 0) {
        ...
        Boat_to_Orbis.announce(Packages.tools.packets.CField.ContiMove.Move.MoveField(true));
        Boat_to_Ellinia.announce(Packages.tools.packets.CField.ContiMove.Move.MoveField(true));
