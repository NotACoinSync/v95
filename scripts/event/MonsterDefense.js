...
function doStart(eim){
	...
	map.announce(Packages.tools.MaplePacketCreator.showEffect("praid/clear"));
...
function playerRevive(eim, player) {
	...
	player.getMap().announce(player, Packages.tools.packets.CUserPool.removePlayerFromMap(player.getId()), false);
	player.getMap().announce(player, Packages.tools.packets.CUserPool.spawnPlayerMapobject(player), false);
	return true;
}
