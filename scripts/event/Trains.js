...
function scheduleNew() {
    ...
    Ludibrium_docked.announce(Packages.tools.packets.CField.ContiMove.State(1, false));
...
function takeoff() {
    ...
    Ludibrium_docked.announce(Packages.tools.packets.CField.ContiMove.State(2, false));
