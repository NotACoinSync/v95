	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			//10Chair Gachapon Ticket
				...
				if (cm.getPlayer().getClient().getDonor() >= 6000) {	
			cm.getPlayer().getClient().addDP(-6000);
			cm.getPlayer().dropMessage("You have lost -6000 DP");
