...
function action(mode, type, selection) {
	...
	var selStr = "We're capable of creating ElationMS's exclusive scroll \r\n#b#t2049122##k! Of course, making one is not an easy task... But worry not! Just gather some material to me and a fee of #b30,000,000 mesos#k for our services to #bobtain it#k. You still want to do it?";
        cm.sendYesNo(selStr);
    }
        ...
        var itemSet = new Array(2049122, 7777777);
        // 1x Intermediate Dark Crystal, 1x Intermediate Diamond, 2x Intermediate Black Crystal, 1.2m meso
        //var matSet = new Array(new Array(4251401,4250001,4251301,4001126,4000021,4001006));
        //var matQtySet = new Array(new Array(1,1,2,500,50,10));

        // 10x Dark Crystal, 10x Diamond, 20x Black Crystal, 30m meso.
        var matSet = new Array(new Array(4005004,4021007,4021008,4001126,4000021,4001006));
        var matQtySet = new Array(new Array(10,10,20,500,50,10));
        var costSet = new Array(30000000, 7777777);
