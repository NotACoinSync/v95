...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        qm.sendNext("Wait.. Isn't that.. Red Jade?\r\nWow... you may be stupid and prone to amnesia, but this is why I can't abandon you. Now give me the Crystal!"); //Giant Polearm
    } else if (status == 1) {
        qm.sendNextPrev("Okay, now that I have the Dark Crystal back on, let me work on reawakening more of your abilities. I mean, your level's gone much higher since the last time we met, so I am sure I can work my magic a bit more this time!");
    } else if (status == 2) {
